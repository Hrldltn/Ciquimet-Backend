# Generated by Django 5.0.4 on 2024-08-19 00:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nbo', models.CharField(blank=True, max_length=100, null=True)),
                ('ident', models.CharField(blank=True, max_length=100, null=True)),
                ('t', models.CharField(blank=True, max_length=100, null=True)),
                ('peso_m', models.FloatField(blank=True, null=True, verbose_name='PesoM. (g)')),
                ('v_ml', models.FloatField(blank=True, null=True, verbose_name='V. mL')),
                ('l_ppm', models.FloatField(blank=True, null=True, verbose_name='L. ppm')),
                ('l_ppm_bk', models.FloatField(blank=True, null=True, verbose_name='L. ppm-BK')),
